...
import App.denormalize_station_prices as denormlz_station_prices
...
def api_launch_complete_pipeline_oil_prices():
    ...
    try:
        ...
        denormlz_station_prices.denormalize_station_prices_for_dataviz(year_to_load, drop_mongo_collections)
        return 'done'
    finally:
